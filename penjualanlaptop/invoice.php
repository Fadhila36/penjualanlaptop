            ...
            <tr class="top">
                <td colspan="5">
                    <table>
                        <tr>
                            <td class="title">
                                <p style="font-size: 20px;">PENJUALAN ELEKTRONIK
                            </td>
            ...
            <tr class="information">
                <td colspan="5">
                    <table>
                        <tr>
                            <td>
                                Jl. Arief Rahman Hakim (Niaga) No. 9 <br>
                                Kel. Karawang Kulon, Karawang Kulon,<br>
                                Kec. Karawang Bar., Kabupaten Karawang, Jawa Barat 41311
                            </td>
                            
                            <td>
                                Pen Computer<br>
                                wwww.pencomputer.com<br>
                                pencom@gmail.com
                            </td>
                        </tr>
                    </table>
